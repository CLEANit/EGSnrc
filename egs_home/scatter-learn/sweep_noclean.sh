...
geo_mask_file=scatter-learn_-_"$id"_-_include_scatter_media.dat
...
output_file=scatter-learn_-_"$id"_-_include_scatter_media.dat 
./output_parse_-_scatter_media.sh $output_file
#
